...
class TodolistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todolist" do
    assert_difference('Todolist.count') do
      post todolists_url, params: { todolist: { Date: @todolist.Date, Time: @todolist.Time, Todo: @todolist.Todo, important: @todolist.important, status: @todolist.status } }
    end
  ...
  test "should update todolist" do
    patch todolist_url(@todolist), params: { todolist: { Date: @todolist.Date, Time: @todolist.Time, Todo: @todolist.Todo, important: @todolist.important, status: @todolist.status } }
